...
if __name__ == '__main__':
    # Use regular, synchronous PyMongo for startup tasks
    ...
    # Create an asynchronous Motor connection to MongoDB
    motor_connection = motor.MotorConnection()

    # Open it synchronously, before starting web server -- once web server is
    # started all operations should be done asynchronously.
